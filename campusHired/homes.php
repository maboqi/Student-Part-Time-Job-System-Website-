...
<div class="header">
    <h2>Student: <?php if(isset($_SESSION["user_id"])) echo $_SESSION["user_id"] ?>, Welcome Back</h2>
...
<div class="job-grid">
    ...
    if ($stmt->rowCount() > 0) {
        ...
        echo "</div>";
        ?>
        <button class='details-button' onclick="window.location.href='applyform.php?id=<?php echo $row['jobid']; ?>'">Detail</button>
        <?php
